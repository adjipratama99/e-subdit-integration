...
const tableName = process.env.NEXT_PUBLIC_PERSONNEL_EDUCATION_NAME as string;
...
export async function POST(req: Request) {
  ...
  try {
    switch (action) {
      case "CREATE": {
        let newPendidikan = {...params}
        delete newPendidikan.action
        ...
        return NextResponse.json({
          code: 0,
          content: data,
          message: "Pendidikan Personel created successfully",
        });
      }
      ...
      case "READ": {
        ...
        const searchColumns = ["jenis", "nama_sekolah", "tahun_mulai", "tahun_selesai"];
        ...
        return NextResponse.json({
          ...
          message: "Pendidikan Personel fetched successfully",
        });
      }
      ...
      case "UPDATE": {
        ...
        return NextResponse.json({
          code: 0,
          content: data,
          message: "Pendidikan Personel updated successfully",
        });
      }
      ...
      case "DELETE": {
        ...
        return NextResponse.json({
          code: 0,
          message: "Pendidikan Personel deleted successfully",
        });
      }
