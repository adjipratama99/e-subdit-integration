...
import { GET_LIST_PERSONNEL_EDUCATION } from "@/constant/key";
import { PendidikanPersonelFormContent } from "./components/insert-content";
...
export default function Dashboard(): React.JSX.Element {
    ...
    const {
        ...
        rowEachPage: 10,
        queryKey: [GET_LIST_PERSONNEL_EDUCATION, sort, search],
        url: "/api/pendidikan",
        params: {
            action: "READ",
    ...
    return (
        <div className="p-4">
            <div className="flex w-full min-w-0 justify-between items-center flex-wrap gap-4 mb-4">
                <h1 className="text-xl font-bold flex-shrink-0">Data Pendidikan Personel</h1>
                <div className="flex-shrink-0">
                    <Modal
                        ...
                        content={<PendidikanPersonelFormContent onSuccess={() => setOpen(false)} />}
                    />
                </div>
            </div>
